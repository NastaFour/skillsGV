...
multi-agent stack: Spec-Driven Development (SDD) orchestrator, 209 skills,
...
| **skillsGV catalog** | 209 skills vendored under skills/ (skillsGV + mattpocock + 20-agent roster: sdd-* phases, judgment-day, review-* lenses, design-driven, skill-harvest, ...) |
...
1. copies the 209 skills to ~/.agents/skills
