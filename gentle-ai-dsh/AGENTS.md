...
skill-router** para bajar 210 → 3-5 candidatas. No leas el cuerpo de una skill
...
El catálogo (210 skills de skillsGV) vive en **~/.agents/skills**. Cargá una por
nombre con la herramienta **skill**. Antes de cualquier turno que pueda cargar
otra skill, usá **skill-router** para reducir 210 → 3-5 candidatas. El catálogo
