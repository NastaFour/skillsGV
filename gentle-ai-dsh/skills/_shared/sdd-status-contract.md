...
- If no active changes exist, report that no SDD change is active and suggest starting one in natural language (slash alias per runtime — 2.7.0 verified: `/sdd-new <change>`).
