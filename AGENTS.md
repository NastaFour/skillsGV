...
|---|---|---|
| Planning & Process | `01-planning-process/` | project-tracker, tech-stack-advisor, application-workflow, master-prompt, agents, engram-integration, speckit-integration, session-notes, parallelization, tech-escalation-adr, idea-to-prd-express |
| Dev Roles (SDD) | `02-dev-roles/` | architecture-designer, code-reviewer, dod-checker, expert-debugger, security-audit, feature-implementer, frontend-designer, frontend-design, judgment-day, decision-gate, github-pr, performance-refactor, qa-tester, technical-writer |
...
| Backend | `04-backend/` | docker, error-handling, mcp-integration, api-design, expressjs, jwt-bcrypt, microservices, nodejs, payments, postgresql, prisma-orm, socketio |
| Frontend | `05-frontend/` | electronjs, expo-production-auditor, maps-gps, nextjs, nextjs-15, push-notifications, pwa-capacitor, react-native, react-vite, react-19, ai-ui-generation, tailwindcss, tailwind-4, zod-4, zustand-5, angular-core, angular-forms, angular-performance, angular-architecture, state-management |
| Code Quality | `06-code-quality/` | pnpm-workspaces, turborepo, biome, changesets, env-management, solid-clean-code, typescript, dependency-guardian |
| Testing | `07-testing/` | testing-patterns, playwright |
...
| Meta-Skills | `00-meta-skills/` | skill-creator, skill-sync, skill-validator, skill-router |
...
> - **Tier 1 (on-demand via `skill-router`):** las 98 skills restantes. El router decide cuáles cargar por turn — el agente solo carga Tier 1 skills listadas en `tier1toLoad` del output del router.
>
...
| Bug complejo / no obvio | `02-dev-roles/expert-debugger` |
| Security audit / vulnerability scan | `02-dev-roles/security-audit` |
| Performance issues | `02-dev-roles/performance-refactor` |
...
| Versioning / changelog / release | `06-code-quality/changesets` |
